...
const StickyNavbar = () => {
    ...
    return (
        <div>
             <nav className=" glass text-white shadow dark:bg-gray-800">
          ...
          >
            ...
            {isDropdownOpen && (
                ...
                >
                    ...
                    <Link to={"/my-ordered-food"} className="block px-4 py-3 text-sm text-gray-600 capitalize transition-colors duration-300 transform dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white"> My ordered food item </Link>
                </div>
            )}
        </div>
